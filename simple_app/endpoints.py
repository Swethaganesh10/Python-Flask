...
con_string = "mongodb+srv://Swetha:Swetha@cluster0.xluvypy.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('project')

user_collection = pymongo.collection.Collection(db, 'firstproject ') #(<database_name>,"<collection_name>")
